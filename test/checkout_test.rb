...
class CheckoutTest < Minitest::Test
  ...
  def test_checkout
    ...
    # assert_equal Checkout.new.checkout("S"), 20
    # assert_equal Checkout.new.checkout("ST"), 40
    ...
    # assert_equal Checkout.new.checkout("XYZTXY"), 90
    # assert_equal Checkout.new.checkout("XYZTXYEEEB"), 210
    # assert_equal Checkout.new.checkout("XYZTXYEEEBFFFFFF"), 250
    assert_equal Checkout.new.checkout("SSS"), 45
    assert_equal Checkout.new.checkout("SSSZ"), 65
    assert_equal Checkout.new.checkout("ZZZ"), 45
